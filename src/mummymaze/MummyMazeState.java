...
//                    columnHero = j;
                ...
                if (this.matrix[i][j] == 'A') { //stores the trap's position in the matrix
                    if (traps != 0) {
...
//            }
            if(gameOver || hasKilledHero(lineMummy, columnMummy)){ //se mudar esta condição para &&, dá index out of bounds no moveUp()
                break;
            }
            // Colunas primeiro
